...
export class ItemService {
    ...
    constructor(){
        ...
        this.items.set("One FM",{id: 3 , streamurl: "https://onefm.ice.infomaniak.ch/onefm-high.mp3", image: "https://www.onefmunplugged.ch/wp-content/uploads/2019/09/onefm-unplugged-rgb-1.png",description:"quel couleur ta radio?" ,favoris:false}),
        this.items.set("Lausanne FM",{ id: 4, streamurl: "https://lausannefm.ice.infomaniak.ch/lausannefm-high.mp3", image: "https://upload.wikimedia.org/wikipedia/fr/f/f7/Logo-lfm.jpg", description:"LFM, c'est LA radio à Lausanne. Musique, humour et actualités régionales, nous vous accompagnons tout au long de la journée!", favoris:false}),
        this.items.set("Radio Inca",{id: 5, streamurl:"https://17853.live.streamtheworld.com/CRP_INC_SC?type=20001", image: "https://upload.wikimedia.org/wikipedia/commons/0/0c/Logo_radio_Inca_AM.png", description:"Los grandes del folklore y la saxo cumbia están en Radio Inca, 540 AM.", favoris:false}),
        this.items.set("Radio Corazon",{id: 6, streamurl:"https://17833.live.streamtheworld.com/RADIO_CORAZON_SC", image:"https://pbs.twimg.com/profile_images/930069522647838720/Jfw9W33Y_400x400.jpg", description:"BUENOS DÍAS CORAZÓN. Programa diseñado para la mujer de hoy, con consejos prácticos, tips, actualidad y las mejores baladas seleccionadas ...", favoris:false}),
        this.items.set("Radio Moda Te Mueve", {id: 7, streamurl:"https://19493.live.streamtheworld.com/CRP_MOD_SC?dist=20001", image:"https://pbs.twimg.com/profile_images/970713153414852609/CY42iAgi_400x400.jpg", description:"Lo último de las noticias de artistas de reggaeton, latin urban, bachata y salsa. Escucha aquí El Show de Carloncho, Luigi Flow, Jojojonathan y muchos más.", favoris:false})
